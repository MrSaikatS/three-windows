...
- **`styles/globals.css`** — shadcn theme tokens + `@import "tailwindcss"`. Generated by shadcn; don't hand-edit unless you mean to.
- **`src/index.css`** — app-level `@layer base` styles. Its first line `@import "../styles/globals.css";` is mandatory.
